-- AlterTable
ALTER TABLE "FinancialSettings" ALTER COLUMN "ratingGreatPerMile" SET DEFAULT 1.25,
ALTER COLUMN "ratingGoodPerMile" SET DEFAULT 0.9,
ALTER COLUMN "ratingMarginalPerMile" SET DEFAULT 0.6;
