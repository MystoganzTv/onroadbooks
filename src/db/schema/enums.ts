...
export const documentType = pgEnum("DocumentType", ["RATE_CONFIRMATION","BOL","POD","INVOICE","RECEIPT","REGISTRATION","INSURANCE","TITLE","INSPECTION","OTHER","DRIVER_CARRIER_INFORMATION_SHEET"]);
