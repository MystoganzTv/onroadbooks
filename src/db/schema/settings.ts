...
export const financialSettings = pgTable("FinancialSettings", {
  ...
  ratingGreatPerMile: numeric("ratingGreatPerMile", { precision: 8, scale: 2 }).notNull().default(sql`1.25`),
  ratingGoodPerMile: numeric("ratingGoodPerMile", { precision: 8, scale: 2 }).notNull().default(sql`0.9`),
  ratingMarginalPerMile: numeric("ratingMarginalPerMile", { precision: 8, scale: 2 }).notNull().default(sql`0.6`),
