  ...
  return (
    <ResponsiveContainer width="100%" height={height}>
      <BarChart data={data} margin={{ top: 8, right: 8, left: -12, bottom: 0 }} barGap={2}>
        ...
        />
        <Bar dataKey="revenue" name="Revenue" fill="hsl(var(--pos))" radius={[2, 2, 0, 0]} maxBarSize={26} />
        <Bar dataKey="expenses" name="Expenses" fill="hsl(var(--neg))" radius={[2, 2, 0, 0]} maxBarSize={26} />
      </BarChart>
    </ResponsiveContainer>
  );
}
