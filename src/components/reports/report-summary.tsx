...
export function ReportSummary({
  ...
  const rows: Row[] = [
    {
      label: "Gross Revenue",
      current: formatMoney(current.grossRevenue),
      previous: formatMoney(previous.grossRevenue),
      delta: pctChange(current.grossRevenue, previous.grossRevenue),
      emphasis: true,
    },
    {
    ...
    {
      label: "Net Profit",
      current: formatMoney(current.netProfit),
      previous: formatMoney(previous.netProfit),
      delta: pctChange(current.netProfit, previous.netProfit),
      emphasis: true,
