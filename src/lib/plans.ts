...
export const PLANS: Record<PlanId, Plan> = {
  ...
  FLEET: {
    ...
    features: [
      ...
      "Individual sign-ins with Owner, Admin, Bookkeeper and Dispatcher roles",
      "Drivers stay operational records; adding one never creates app access",
      "Load assignments and frozen driver-pay statements",
