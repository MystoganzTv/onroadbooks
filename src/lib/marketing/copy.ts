...
const en = {
  ...
  pricing: {
    ...
    sub: `Start with a ${TRIAL_DAYS}-day Pro trial for one truck. No card required.`,
    per: "/month",
    plans: [
      {
        id: "SOLO",
        ...
        featured: false,
        cta: "Start free trial",
        tagline: "Keep track of one truck’s income and costs.",
        features: [
          "One truck, unlimited loads",
          "Income received and optional recurring expenses",
          "Fuel, receipts and documents",
          "Profit after trip costs, per load and per mile",
          "Cost per mile from your recorded expenses",
      ...
      },
      {
        ...
        featured: true,
        cta: "Start free trial",
        tagline: "Plan rates, reserves and your next move.",
        features: [
          "Everything in Solo Starter",
          "Load calculator and target rates",
          "Broker and lane comparisons",
      ...
      {
        id: "FLEET",
        badge: "For your fleet",
        featured: false,
        cta: "Get started",
        tagline: "Manage trucks, drivers and your team together.",
        features: [
          "Everything in OnRoad Pro",
          "Up to eight trucks in one account",
          "Team sign-ins with separate permissions",
          "Drivers, load assignments and pay statements",
          "Cost and profit comparisons by truck",
          "Shared business costs tracked separately",
          "Owner-only reserves and fleet financial summaries",
        ],
        note: "Upgrade to Fleet in the same account. Fleet tools are available on the web; fleet screens in the iPhone app are still in development.",
      },
    ],
  },
  faq: {
...
const es: LandingCopy = {
  ...
  pricing: {
    ...
    sub: `Empieza con ${TRIAL_DAYS} días de prueba Pro para un camión. Sin tarjeta.`,
    per: "/mes",
    plans: [
      {
        id: "SOLO",
        ...
        featured: false,
        cta: "Prueba gratis",
        tagline: "Controla los ingresos y costos de un camión.",
        features: [
          "Un camión, cargas ilimitadas",
          "Ingresos recibidos y gastos recurrentes opcionales",
          "Combustible, recibos y documentos",
          "Ganancia tras los costos del viaje, por carga y milla",
          "Costo por milla según tus gastos registrados",
          "Reportes para imprimir y exportar en CSV",
        ],
        note: null,
      },
      {
        ...
        featured: true,
        cta: "Prueba gratis",
        tagline: "Planifica tarifas, reservas y tus próximos pasos.",
        features: [
          "Todo lo de Solo Starter",
          "Calculadora de cargas y tarifas objetivo",
          "Comparación de brokers y rutas",
      ...
      },
      {
        ...
        featured: false,
        cta: "Comenzar",
        tagline: "Gestiona camiones, choferes y equipo en una cuenta.",
        features: [
          "Todo lo de OnRoad Pro",
          "Hasta ocho camiones en una cuenta",
          "Accesos para el equipo con permisos separados",
          "Choferes, asignación de cargas y estados de pago",
          "Comparación de costos y ganancias por camión",
          "Gastos generales del negocio por separado",
          "Reservas y resúmenes de flota exclusivos del dueño",
        ],
        note: "Cambia a Fleet en la misma cuenta. Las herramientas de flota están disponibles en la web; las pantallas de flota en iPhone siguen en desarrollo.",
      },
    ],
  },
  faq: {
