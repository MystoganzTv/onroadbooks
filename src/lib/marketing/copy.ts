  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        ...
        note: "Fleet is activated separately from a one-truck account. Everything listed here works on the web today, individual sign-ins included; the fleet screens on the iPhone app are still on the way.",
      },
    ],
  },
  faq: {
  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        ...
        note: "Fleet se activa por separado de una cuenta de un solo camión. Todo lo listado aquí funciona hoy en la web, incluidos los accesos individuales; las pantallas de flota en la app de iPhone todavía están en camino.",
      },
    ],
  },
  faq: {
