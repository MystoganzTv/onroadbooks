    ...
    plans: [
      {
        ...
        features: [
          ...
          "1-15 and 16-end settlements with reserve buckets",
      ...
      },
      {
        ...
        features: [
          ...
          "Up to five trucks on one account",
          "Cost per mile and contribution per unit",
          "Business overhead kept separate from truck costs",
          "Fleet-wide settlements",
        ],
        note: "Fleet is in early access - the per-truck views ship as owners bring on a second truck, and early access pricing is locked for life.",
      },
    ],
  },
  faq: {
    ...
    plans: [
      {
        ...
        name: "Individual",
        price: "$29",
        tagline: "Un camión, y todos sus números.",
        badge: "La mayoría",
        featured: true,
        cta: "Prueba gratis",
        features: [
          ...
          "Costo real por milla y cuánto puedes pagarte",
          "Calculadora de carga y tarifa objetivo",
          "Cortes 1-15 y 16-fin con reservas",
      ...
      },
      {
        ...
        name: "Fleet",
        price: "$49",
        tagline: "Hasta cinco camiones, cada uno con su economía.",
        badge: "Acceso anticipado",
        featured: false,
        cta: "Prueba gratis",
        features: [
          "Todo lo de Individual",
          "Hasta cinco camiones en una cuenta",
          "Costo por milla y aporte por unidad",
          "Gastos del negocio separados de los del camión",
          "Cortes de toda la flota",
        ],
        note: "Fleet está en acceso anticipado - las vistas por camión van saliendo conforme los dueños suman el segundo camión, y el precio de acceso anticipado queda fijo de por vida.",
      },
    ],
  },
  faq: {
